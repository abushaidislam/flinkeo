  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 w-full rounded-[var(--radiusSm)] border border-[color:var(--border)] bg-[color:var(--panel)] px-3 text-[14px] text-[color:var(--text)] shadow-[0_1px_0_rgba(20,20,20,0.03)]",
